...
namespace MVC5.Models
{
    ...
    public class Study
    {
        ...
        public virtual ICollection<TreatmentIndication> SubjectCharactersictics { get; set; }
    }
    ...
    public class Trail
    {
        ...
        public virtual TreatmentOption ExperimentalTreatment { get; set; }

        public int? ControlTreatmentOptionID { get; set; }
        public virtual TreatmentOption ControlTreatment { get; set; }
